...
-- Generated: 2026-06-29T17:10:49.502Z
-- ============================================================
...
-- Table: audit_logs
CREATE TABLE audit_logs (id integer NOT NULL DEFAULT nextval('audit_logs_id_seq'::regclass), user_id integer, actor_name character varying(255), actor_role user_role, action character varying(100) NOT NULL, entity character varying(100), entity_id character varying(100), details jsonb, ip_address character varying(50), created_at timestamp without time zone DEFAULT now());
